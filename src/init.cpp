...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Vcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  vcoind [options]                     " + "\n" +
                  "  vcoind [options] <command> [params]  " + _("Send command to -server or vcoind") + "\n" +
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: vcoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: vcoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Vcoin Wiki for SSL setup instructions)") + "\n" +
